...
public class ListarPedidoBpb  extends AsyncTask<String, String, String> {

    @Override
    protected String doInBackground(String... params) {

        String api_url = "URL:http://www.mlprojetos.com/webservice/index.php/pedido/getPedidosPorEstabelecimentoBtoB/" + params[0];
            ...
            if (status_est.equals("true")) {
                ...
                for (int j = 0; j< dados.length(); ++j){
                    ...
                    pedido = new Pedido(lote_result.getString("pedido_id"),lote_result.getString("estabelecimento_id"),
                            ...
                            lote_result.getString("estabelecimento_comprador"));
                    pedidos.add(pedido);
                }
