...
/**
 * Created by talit on 01/11/2017.
 */

public class LotePorSubcategoria extends AsyncTask<String, String, String> {
    ...
    public LotePorSubcategoria(Listener mListener){
    ...
    protected String doInBackground(String... params) {
        ...
        String api_url = "http://www.mlprojetos.com/webservice/index.php/produto/getLotesBySubcategoria/" + params[0] + "/";
