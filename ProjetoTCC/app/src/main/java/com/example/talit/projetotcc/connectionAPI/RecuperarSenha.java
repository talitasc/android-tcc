...
public class RecuperarSenha  extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            if (status_user.equals("true")) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(LoginCliente.context);
                builder.setTitle(LoginCliente.context.getString(R.string.txt_enviado));
                builder.setMessage(LoginCliente.context.getString(R.string.txt_emailenviado));
                builder.setPositiveButton("Fechar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        LoginCliente.dialogo.dismiss();
                    }
                });
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(LoginCliente.context);
                builder.setTitle(LoginCliente.context.getString(R.string.txt_enviado_erro));
                builder.setMessage(LoginCliente.context.getString(R.string.txt_noencontrado));
                builder.setPositiveButton("Fechar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
            ...
            e.printStackTrace();
            LoginCliente.pbRecuperar.setVisibility(View.INVISIBLE);
