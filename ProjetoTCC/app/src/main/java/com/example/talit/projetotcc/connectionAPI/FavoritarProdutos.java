...
public class FavoritarProdutos extends AsyncTask<String, String, String> {
    ...
    public FavoritarProdutos(Listener listener) {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            if (status_user.equalsIgnoreCase("true")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(PaginaInicialEstabelecimentos.context);
                    builder.setTitle(R.string.txt_alterados);
                    builder.setMessage(R.string.favoritar_produto);
