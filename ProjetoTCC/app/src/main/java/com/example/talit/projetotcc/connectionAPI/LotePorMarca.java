...
public class LotePorMarca extends AsyncTask<String, String, String> {
    ...
    public LotePorMarca(Listener mListener){
    ...
    protected String doInBackground(String... params) {
        ...
        String api_url = "http://www.mlprojetos.com/webservice/index.php/produto/getLotesByMarca/" + params[0] + "/";
